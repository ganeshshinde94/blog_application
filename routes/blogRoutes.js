...
router.post("/addedBlog", isLoggedIn, function (req, res) {
  ...
  .then(function (newAddedBlog) {
      ...
      res.staus(201).json(newAddedBlog);
  })
    .catch(function (err) {
    console.log("========ERROR=======");
    console.log(err);
...
Blog.findById(rq.params.blogId)
...
router.put("/blogs/:blogsId",isLoggedIn ,function (req,res) {
